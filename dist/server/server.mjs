...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Do3a_CBl.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CUOzYYmk.mjs").then((n) => n.ab),
    import("./assets/start-HYkvq4Ni.mjs"),
    import("./assets/__23tanstack-start-plugin-adapters-Cwee5PKy.mjs")
  ]);
  return {
    routerEntry,
    startEntry,
