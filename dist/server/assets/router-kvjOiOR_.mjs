...
import { sql, relations, and, eq, isNull, or, gt, asc, like, inArray, desc, gte, lte, lt, ne } from "drizzle-orm";
import { sqliteTable, integer, text, index, uniqueIndex, real } from "drizzle-orm/sqlite-core";
import { SignJWT, jwtVerify, decodeProtectedHeader, jwtDecrypt, calculateJwkThumbprint, base64url, EncryptJWT } from "jose";
import { createClient } from "@libsql/client";
import { drizzle } from "drizzle-orm/libsql";
import { anthropic } from "@ai-sdk/anthropic";
import { generateText, tool, convertToModelMessages, streamText, stepCountIs } from "ai";
...
const $$splitComponentImporter$h = () => import("./register-TKdDUsra.mjs");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./login-C8B2XHhT.mjs");
const Route$o = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./route-CugOr8Vw.mjs");
...
const Route$l = createFileRoute("/app/")({
  beforeLoad: () => {
    throw redirect({ to: "/app/workouts" });
  }
});
const $$splitComponentImporter$e = () => import("./progress-CZBSwwYj.mjs");
const Route$k = createFileRoute("/app/progress")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./profile-DQeez354.mjs");
const Route$j = createFileRoute("/app/profile")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./calendar-C_2MRF4x.mjs");
const Route$i = createFileRoute("/app/calendar")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./route-CiAPmkAL.mjs");
const Route$h = createFileRoute("/app/workouts")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./route-CbTbVqO5.mjs");
const Route$g = createFileRoute("/app/nutrition")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./route-BFsOu0JM.mjs");
const Route$f = createFileRoute("/app/coach")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./index-wbwCDHr4.mjs");
const Route$e = createFileRoute("/app/workouts/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./index-BKeSinWY.mjs");
const Route$d = createFileRoute("/app/nutrition/")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./index-qYXOEcMr.mjs");
const Route$c = createFileRoute("/app/coach/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./calendar-C7MCN9Bc.mjs");
const Route$b = createFileRoute("/app/workouts/calendar")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./_id-DP619vbW.mjs");
const Route$a = createFileRoute("/app/workouts/$id")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./plan-Dh5xQYqW.mjs");
const Route$9 = createFileRoute("/app/nutrition/plan")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./library-Dq3StA5P.mjs");
const Route$8 = createFileRoute("/app/nutrition/library")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_id-BMAWxM8K.mjs");
const Route$7 = createFileRoute("/app/coach/$id")({
...
async function handlePull(name, userId, cursor, limit) {
  ...
  const where = userIdCol ? afterCursor ? and(eq(userIdCol, userId), afterCursor) : eq(userIdCol, userId) : afterCursor;
...
async function handlePush(name, userId, rows) {
  ...
  await db.transaction(async (tx) => {
    for (const { newDocumentState } of rows) {
      ...
      const [existing] = await tx.select().from(table).where(eq(idCol, candidateId)).limit(1);
      if (existing) {
      ...
      const [written] = await tx.select().from(table).where(eq(idCol, candidateId)).limit(1);
...
const Route$6 = createFileRoute("/api/sync/$collection")({
  server: {
    handlers: {
      GET: handle,
      POST: handle
...
const updateUserProfileInput = z$1.object({
  ...
  (o) => o.name !== void 0 || o.heightIn !== void 0 || o.goalPreset !== void 0 || o.fitnessGoals !== void 0 || o.preferences !== void 0 || o.goalCalories !== void 0 || o.goalProteinG !== void 0 || o.goalCarbsG !== void 0 || o.goalFatG !== void 0,
  { message: "Provide at least one field" }
);
const TRAINLOG_TOOL_DEFINITIONS = [
  {
    name: "list_workout_templates",
    description: "List saved workout templates with exercises and set/rep targets.",
  ...
  },
  {
    ...
    description: "Create a new empty workout template (saved routine). Add lifts with bulk_add_exercises_to_template or add_exercise_to_template, then start_workout when ready.",
...
The current date is ${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.`;
}
...
async function persistSlotLabelsForDay(dbh, planId, dayIndex) {
  ...
  for (const s of slots) {
    ...
    if (label && label !== s.label) {
      await dbh.update(mealPlanSlots).set({ label }).where(eq(mealPlanSlots.id, s.id));
    }
  }
}
...
function insertDefaultWeekSlots(planId) {
  const rows = [];
...
async function ensureDefaultSlotsForPlan(planId) {
  ...
  await db.update(mealPlanSlots).set({ label: DEFAULT_MEAL_LABELS[0] }).where(
    and(
      eq(mealPlanSlots.planId, planId),
  ...
  await db.update(mealPlanSlots).set({ slotKind: "snack" }).where(
    and(
      eq(mealPlanSlots.planId, planId),
...
async function setSlotLibraryItem(userId, input) {
  ...
  const now2 = /* @__PURE__ */ new Date();
  await db.update(mealPlanSlots).set({ libraryItemId: input.libraryItemId }).where(eq(mealPlanSlots.id, input.slotId));
...
async function setPlanSlotsBatch(userId, input) {
  ...
  await db.transaction(async (tx) => {
    ...
    for (const r of resolved) {
      await tx.update(mealPlanSlots).set({ libraryItemId: r.libraryItemId }).where(eq(mealPlanSlots.id, r.slotId));
    }
...
async function generateStructuredShoppingList(raw, weekStartDayKey) {
  ...
  const prompt = `You format grocery lists for real-world shopping (US supermarkets, typical package sizes, rough mid-range prices).
...
async function updateUserProfile(userId, patch) {
  ...
  const hasProfileFields = patch.heightIn !== void 0 || patch.goalPreset !== void 0 || patch.fitnessGoals !== void 0 || patch.preferences !== void 0 || patch.goalCalories !== void 0 || patch.goalProteinG !== void 0 || patch.goalCarbsG !== void 0 || patch.goalFatG !== void 0;
  if (!hasProfileFields) {
...
function createCoachTools(userId) {
  return {
    ...
    suggest_quick_replies: tool({
      description: "Emit tap-ready follow-up prompts for this turn. Call exactly once per coach reply, after your user-visible answer (and after any Trainlog data tools). Each element of `suggestions` is `{ text, emoji? }`: keep `text` emoji-free; set `emoji` on each row when possible (the UI prefixes each chip). Do not describe this tool in prose to the user.",
...
async function handlePost$1({ request }) {
  ...
  try {
    const { systemWithProfile, modelMessages, modelId, tools } = await getCoachModelInput(userId, messages);
    ...
    return result.toUIMessageStreamResponse({
      onError: (error2) => {
        ...
        return isCoachAiDebugEnabled() ? debugErrorBody(error2) ?? "Unknown stream error." : USER_SAFE_ERROR;
      }
    });
  } catch (error2) {
...
const Route$5 = createFileRoute("/api/coach/chat")({
  server: {
    handlers: {
      POST: handlePost$1
    }
...
const Route$4 = createFileRoute("/api/auth/refresh")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const Route$3 = createFileRoute("/api/auth/device-tokens")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const $$splitComponentImporter = () => import("./session._sessionId-DkOKaaSi.mjs");
const Route$1 = createFileRoute("/app/workouts/session/$sessionId")({
...
const Route = createFileRoute("/api/nutrition/meal-plan/shopping-list")({
  server: {
    handlers: {
      GET: handleGet,
      POST: handlePost
...
const AppRouteRoute = Route$n.update({
  id: "/app",
  path: "/app",
  getParentRoute: () => Route$q
});
...
const AppIndexRoute = Route$l.update({
  id: "/",
  path: "/",
  getParentRoute: () => AppRouteRoute
});
const AppProgressRoute = Route$k.update({
  id: "/progress",
  path: "/progress",
  getParentRoute: () => AppRouteRoute
});
...
const AppCalendarRoute = Route$i.update({
  id: "/calendar",
  path: "/calendar",
  getParentRoute: () => AppRouteRoute
});
const AppWorkoutsRouteRoute = Route$h.update({
  id: "/workouts",
  path: "/workouts",
  getParentRoute: () => AppRouteRoute
});
const AppNutritionRouteRoute = Route$g.update({
  id: "/nutrition",
  path: "/nutrition",
  getParentRoute: () => AppRouteRoute
});
const AppCoachRouteRoute = Route$f.update({
  id: "/coach",
  path: "/coach",
  getParentRoute: () => AppRouteRoute
});
const AppWorkoutsIndexRoute = Route$e.update({
  id: "/",
  path: "/",
  getParentRoute: () => AppWorkoutsRouteRoute
});
const AppNutritionIndexRoute = Route$d.update({
  id: "/",
  path: "/",
  getParentRoute: () => AppNutritionRouteRoute
});
const AppCoachIndexRoute = Route$c.update({
  id: "/",
  path: "/",
  getParentRoute: () => AppCoachRouteRoute
});
const AppWorkoutsCalendarRoute = Route$b.update({
  id: "/calendar",
  path: "/calendar",
  getParentRoute: () => AppWorkoutsRouteRoute
});
const AppWorkoutsIdRoute = Route$a.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => AppWorkoutsRouteRoute
});
const AppNutritionPlanRoute = Route$9.update({
  id: "/plan",
  path: "/plan",
  getParentRoute: () => AppNutritionRouteRoute
});
const AppNutritionLibraryRoute = Route$8.update({
  id: "/library",
  path: "/library",
  getParentRoute: () => AppNutritionRouteRoute
});
const AppCoachIdRoute = Route$7.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => AppCoachRouteRoute
});
const ApiSyncCollectionRoute = Route$6.update({
  id: "/api/sync/$collection",
  path: "/api/sync/$collection",
  getParentRoute: () => Route$q
});
const ApiCoachChatRoute = Route$5.update({
  id: "/api/coach/chat",
  path: "/api/coach/chat",
  getParentRoute: () => Route$q
});
const ApiAuthRefreshRoute = Route$4.update({
  id: "/api/auth/refresh",
  path: "/api/auth/refresh",
  getParentRoute: () => Route$q
});
const ApiAuthDeviceTokensRoute = Route$3.update({
...
const AppWorkoutsSessionSessionIdRoute = Route$1.update({
  id: "/session/$sessionId",
  path: "/session/$sessionId",
  getParentRoute: () => AppWorkoutsRouteRoute
});
const ApiNutritionMealPlanShoppingListRoute = Route.update({
