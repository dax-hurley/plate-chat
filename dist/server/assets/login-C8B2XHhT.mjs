...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "auth-shell min-h-dvh flex items-center justify-center p-6", children: /* @__PURE__ */ jsxs("form", { onSubmit, className: "w-full max-w-sm space-y-4 bg-card border rounded-2xl p-6 shadow-sm", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "A connection is required for first sign-in. After that the app works offline." })
    ] }),
    !online ? /* @__PURE__ */ jsx("div", { className: "rounded-md border border-amber-500/50 bg-amber-500/10 p-3 text-sm text-amber-900 dark:text-amber-200", children: "You're offline. Reconnect to sign in." }) : null,
    ...
    /* @__PURE__ */ jsxs("label", { className: "block", children: [
      ...
      /* @__PURE__ */ jsx("input", { className: "mt-1 block w-full rounded-md border bg-background px-3 py-2", type: "password", value: password, onChange: (e) => setPassword(e.target.value), autoComplete: "current-password", required: true })
    ] }),
    error ? /* @__PURE__ */ jsx("p", { className: "text-sm text-destructive", role: "alert", children: error }) : null,
    /* @__PURE__ */ jsx("button", { type: "submit", disabled: loading || !online, className: "w-full rounded-md bg-primary text-primary-foreground py-2 font-medium disabled:opacity-60", children: loading ? "Signing in…" : "Sign in" }),
