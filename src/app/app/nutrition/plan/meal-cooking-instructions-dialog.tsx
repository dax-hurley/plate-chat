...
import { LibraryMealItemDetailContent } from "../library/library-meal-item-detail-content";

type MealCookingInstructionsDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  /** When closed, may be null; when open, should be the meal to show. */
  item: MealLibraryItemJson | null;
  /** Opens the library recipe editor for this meal (e.g. from the meal plan). */
